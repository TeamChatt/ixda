...
gulp.task('presenter-images', tasks.images('./presenter'));
gulp.task('presenter-css'   , tasks.css('./presenter'));
gulp.task('presenter-html'  , tasks.html('./presenter'));

gulp.task('presenter-build', ['presenter-js', 'presenter-svg', 'presenter-images', 'presenter-css', 'presenter-html']);
...
gulp.task('presenter-watch', ['presenter-build'], function(){
  ...
  gulp.watch('presenter/**/*.png' , ['presenter-images']);
