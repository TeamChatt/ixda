...
gulp.task('game-master-images', tasks.images('./game-master'));
gulp.task('game-master-css'   , tasks.css('./game-master'));
gulp.task('game-master-html'  , tasks.html('./game-master'));

gulp.task('game-master-build', ['game-master-js', 'game-master-svg', 'game-master-images', 'game-master-css', 'game-master-html']);
...
gulp.task('game-master-watch', ['game-master-build'], function(){
  ...
  gulp.watch('game-master/**/*.png' , ['game-master-images']);
